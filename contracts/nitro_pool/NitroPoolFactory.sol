...
contract NitroPoolFactory is Ownable, INitroPoolFactory {
  ...
  IKayenToken public kayenToken; // KAYENToken contract's address
  IXKayenToken public xKayenToken; // xKAYENToken contract's address
  ...
  constructor(IKayenToken kayenToken_, IXKayenToken xKayenToken_, address emergencyRecoveryAddress_, address feeAddress_){
  ...
  function createNitroPool(
    ...
    nitroPool = address(
      new NitroPool(
        kayenToken, xKayenToken, msg.sender, INFTPool(nftPoolAddress),
